			...
			if (model.getCurrentReminderObject() != null) {
				...
				JOptionPane
						.showMessageDialog(
								...
								"Keine Erinnerung gew�hlt!\nW�hlen Sie eine Erinnerung aus der Liste und klicken Sie erneut auf \"Editieren!\"",
			...
			case RemindDialog.NEW_MODE:
				...
				if (model.sendNewRemind()) {
					...
					JOptionPane
							.showMessageDialog(
									remindDialog,
									"Es konnte keine Verbindung hergestellst werden.\n�berpr�fen sie ihre Internet verbindung und klicken Sie erneut auf \"Ok\" ",
									"Keine Verbindung",
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (model.deleteRemind()) {
				...
				JOptionPane
						.showMessageDialog(
								remindDialog,
								"Es konnte keine Verbindung hergestellst werden.\n�berpr�fen sie ihre Internet verbindung und klicken Sie erneut auf \"L�schen\" ",
